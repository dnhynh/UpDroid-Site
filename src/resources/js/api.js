...
var Homepage =
{
    ...
    "Exploded": function () {
        ...
        function scrollScene () {
            ...
            baseScene.on('enter', function(event) {
                ...
                baseStart = $(window).scrollTop();
            });

            baseScene.on('leave', function(event) {
                if($(window).scrollTop() <= baseStart) {
    ...
    "Commander": function () {
        ...
        function swapGif() {
            if($("#move-gif").css("display") == "none") {
                $("#point-cloud-gif").css("display", "none");
                $("#move-gif").css("display", "inline");
            }
            else {
                $("#move-gif").css("display", "none");
                $("#point-cloud-gif").css("display", "inline");
            }
        }
